...
def run_task_evaluation(model_args, data_args, training_args, init_args):
    ...
    config = utility_functions.load_config(model_args.model_name_or_path, None, data_args.task_name, model_args.cache_dir, model_args.model_revision, model_args.use_auth_token, "qa")
    tokenizer = utility_functions.load_tokenizer(model_args.model_name_or_path, model_args.cache_dir, model_args.use_fast_tokenizer, model_args.model_revision, model_args.use_auth_token, "left", None)
    model = utility_functions.load_model(model_args.model_name_or_path, bool(".ckpt" in model_args.model_name_or_path), config, model_args.cache_dir, model_args.model_revision, model_args.use_auth_token, "qa")
    ...
    print("modified features", raw_datasets["train"].features)
    ...
    data_collator = utility_functions.data_collator_sequence_classification(data_args, training_args, tokenizer)
    ...
    trainer = utility_functions.set_hub_arguments(trainer, model_args, data_args, training_args, "question-answering")
