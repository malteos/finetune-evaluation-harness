...
def main(args):
    ...
    config = load_config(model_args.model_name_or_path, None, data_args.task_name, model_args.cache_dir, model_args.model_revision, model_args.use_auth_token, "qa")
    tokenizer = load_tokenizer(model_args.model_name_or_path, model_args.cache_dir, model_args.use_fast_tokenizer, model_args.model_revision, model_args.use_auth_token, "left", None)
    model = load_model(model_args.model_name_or_path, bool(".ckpt" in model_args.model_name_or_path), config, model_args.cache_dir, model_args.model_revision, model_args.use_auth_token, "qa")
    ...
    if training_args.do_eval:
        ...
        with training_args.main_process_first(desc="validation dataset map pre-processing"):
            eval_dataset = eval_examples.map(
                prepare_features_validation_qa,
                batched=True,
    ...
    data_collator = data_collator_sequence_classification(data_args, training_args, tokenizer)
    ...
    set_hub_arguments(trainer, model_args, data_args, training_args, "question-answering")
