...
def test_cls_evaluation():
    ...
    metrics_eval = hgf_fine_tune_class.run_task_evaluation(
...
def test_ner_evaluation():
    ...
    metrics_eval = hgf_fine_tune_ner.run_task_evaluation(
        model_args, data_args, training_args, init_args
    )
...
def test_qa_evaluation():
    ...
    metrics_eval = hgf_fine_tune_qa.run_task_evaluation(
        model_args, data_args, training_args, init_args
    )
    print(metrics_eval)
